...
//                         className="flex h-full items-center justify-center rounded-2xl bg-neutral-200 text-4xl text-black dark:bg-neutral-800 dark:text-white transform-gpu transition-all duration-500 will-change-[outline,_transform] group-hover:scale-95 active:scale-100"
...
//                     <div className="group col-span-2 h-full pt-5">
//                       <a
//                         target="_blank"
//                         rel="noopener noreferrer"
//                         className="flex h-full items-center justify-center rounded-2xl bg-neutral-200 text-4xl text-black dark:bg-neutral-800 dark:text-white transform-gpu transition-all duration-500 will-change-[outline,_transform] group-hover:scale-95 active:scale-100"
//                         href="https://discord.com/users/krrish2"
//                       >
...
//         </div>
//       </main>
//       <div className="mx-auto grid max-w-3xl grid-cols-2 gap-6 px-6 pt-16">
...
// provide about section along with shephard.js tour
...
const About = () => {
  ...
  useEffect(() => {
    // Check if the tour has already been initialized
    if (tourRef.current) return;

    // Initialize the tour and store it in the ref
    ...
    tour.addStep({
      id: "step-1",
      text: "This is the introduction section where you can learn about me.",
      attachTo: {
        element: ".hero h1",
        on: "bottom",
      },
    ...
    tour.addStep({
      id: "step-2",
      text: "Here you can see what I'm doing now.",
      attachTo: {
        element: "#what-im-doing-now",
        on: "bottom",
      },
      buttons: [
        {
    ...
    tour.addStep({
      id: "step-3",
      text: "This is the social media section.",
      attachTo: {
        element: ".group",
        on: "top",
      },
